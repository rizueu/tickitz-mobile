        ...
        <View style={styles.parentRootWrapper}>
          <View style={styles.cardInfoProfile}>
            ...
            <View style={styles.rowPicture}>
              ...
              <Text style={styles.textUsername}>Rizki Ramadhan</Text>
              <Text style={{color: 'grey'}}>Moviegoers</Text>
            </View>
          ...
          <View style={styles.cardInfoProfile}>
            ...
            <View>
              <View>
                ...
                <TextInput value="Rizki Ramadhan" style={styles.formInput} />
              </View>
              <View>
                <Text style={styles.labelForm}>Email</Text>
                <TextInput
                  value="rizukirimu@gmail.com"
