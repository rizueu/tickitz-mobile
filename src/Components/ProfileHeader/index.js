...
// import assets
import photo from '../../Assets/Images/nophoto.png';
import HorizontalFill from '../../Assets/Images/horizontal-fill.svg';
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const {data} = await http.getUserDetail(auth.token, id);
        setState((currentState) => ({
          ...
          photo:
            data.results.picture.split('/').pop() === 'null'
              ? null
              : data.results.picture,
        }));
        console.log('PHOTO USER', state.photo);
      } catch (err) {
        console.log(err);
        showMessage({
          message: err.response.data.message,
          ...
          <View style={style.head}>
            <View style={style.containerFixed}>
              ...
              <View style={style.imageHeader}>
                <Image
                  source={{
                    uri: `${REACT_APP_API_URL}profile/${state.photo}`,
                  }}
                  style={style.profile}
                />
